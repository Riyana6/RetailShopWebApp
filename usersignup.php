...
<body>
    <h1 class="head">SignUp For Services</h1>

    <form action="signup.php" class="form2" method="POST">
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="inputEmail4" placeholder="Second Name" name="second_name"
                    required>
            </div>
        ...
        <button type="submit" class="btn btn-primary"><a href="useradmin.php" style="color:white;">Back to
                Homepage</a></button>
    </form>
